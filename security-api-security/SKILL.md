...
description: >
  Comprehensive expert-level implementation of security-api-security methodologies, providing deep 
...
This skill encapsulates the entirety of the security-api-security domain, providing subagents with the exact procedural logic, architectural blueprints, and cryptographic / security primitives required to implement, audit, or enforce security-api-security within enterprise ecosystems.
...
## Agent Protocol
- Triggers: Any mention of security-api-security, security audits, or architectural reviews.
...
```text
  [Ingress] -> [WAF/Gateway] -> [security-api-security Validator] -> [Data Layer]
                                     |
                               [Audit Log]
```
