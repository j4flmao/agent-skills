...
name: security-sbom
description: >
  Comprehensive expert-level implementation of security-sbom methodologies, providing deep 
...
This skill encapsulates the entirety of the security-sbom domain, providing subagents with the exact procedural logic, architectural blueprints, and cryptographic / security primitives required to implement, audit, or enforce security-sbom within enterprise ecosystems.
...
## Agent Protocol
- Triggers: Any mention of security-sbom, security audits, or architectural reviews.
...
```text
  [Ingress] -> [WAF/Gateway] -> [security-sbom Validator] -> [Data Layer]
                                     |
                               [Audit Log]
```
