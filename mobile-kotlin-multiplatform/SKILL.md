...
description: >
  Comprehensive documentation and execution parameters for mobile-kotlin-multiplatform.
...
compatibility:
  ...
  codex: true
  windsurf: true
tags: [mobile-kotlin-multiplatform, mobile, architecture, integration]
---

# mobile-kotlin-multiplatform Skill Documentation

## Purpose
Comprehensive description for mobile-kotlin-multiplatform. This skill facilitates robust execution, bridging high-level design constraints with low-level implementation details to ensure flawless agentic execution.
...
## Agent Protocol
- Triggers: File modifications in `mobile-kotlin-multiplatform` directories.
...
{
  "status": "success",
  "skill": "mobile-kotlin-multiplatform",
  "metrics": { "time_ms": 150 }
}
```
...
```
Client -> Agent -> mobile-kotlin-multiplatform Load -> Validate -> Execute -> Reply
```
