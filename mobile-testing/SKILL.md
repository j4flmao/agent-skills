...
name: mobile-testing
description: >
  Comprehensive documentation and execution parameters for mobile-testing.
...
compatibility:
  ...
  codex: true
  windsurf: true
tags: [mobile-testing, mobile, architecture, integration]
---

# mobile-testing Skill Documentation

## Purpose
Comprehensive description for mobile-testing. This skill facilitates robust execution, bridging high-level design constraints with low-level implementation details to ensure flawless agentic execution.
...
## Agent Protocol
- Triggers: File modifications in `mobile-testing` directories.
...
```
Client -> Agent -> mobile-testing Load -> Validate -> Execute -> Reply
```
