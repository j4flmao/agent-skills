...
description: >
  Comprehensive skill definitions for backend-event-driven.
...
compatibility:
  ...
  codex: true
  windsurf: true
tags: [backend-event-driven, backend, engineering]
---

# backend-event-driven

## Purpose
Comprehensive description for backend-event-driven providing detailed architectures and best practices.
