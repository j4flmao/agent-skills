# GraphQL Patterns: Schema Stitching
...
## GraphQL Schema Design Code
Schema Design allows combining multiple subgraphs into a unified supergraph.

```javascript
// Schema Design Subgraph Example
