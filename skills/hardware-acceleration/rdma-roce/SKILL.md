...
flowchart TD
    subgraph NodeASenderNodeNodeASenderNode ["Node_A['Sender Node<br/>"]
        direction TB
    ...
    subgraph FabricSpineLeafEthernetFabricFabricSpineLeafEthernetFabric ["Fabric['Spine-Leaf Ethernet Fabric<br/>"]
        direction TB
    ...
    subgraph NodeBReceiverNodeNodeBReceiverNode ["Node_B['Receiver Node<br/>"]
        direction TB
