...
flowchart TD
    ...
    subgraph MXUMatrixMultiplicationUnitSystolicArrayMXUMatrixMultiplicationUnitSystolicArray ["<div style='padding-bottom: 40px;'>MXU['Matrix Multiplication Unit (Systolic Array)</div>"]
        direction TB
