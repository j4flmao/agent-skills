...
## Purpose
Deep dive into MVC, Clean Architecture, and microservices in Swift Vapor.
...
protocol UserRegistrationUseCase {
    func execute(req: Request, input: UserRegistrationInput) async throws -> UserResponse
}
struct DefaultUserRegistrationUseCase: UserRegistrationUseCase {
