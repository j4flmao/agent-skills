...
## 1. Test Pyramid
The test pyramid for Spring Boot consists of:
1. Unit Tests (JUnit 5, Mockito)
2. Integration Tests (@SpringBootTest, Testcontainers)
3. End-to-End Tests (Selenium, Cypress, RestAssured)
...
Using Docker containers for real database testing.
