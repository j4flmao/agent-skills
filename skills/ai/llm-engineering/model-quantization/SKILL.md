...
flowchart TD
    ...
    subgraph DataDependentCalibrationDataDependentCalibration ["Data-Dependent Calibration<br/>"]
    ...
    subgraph WeightCompressionWeightCompression ["Weight Compression<br/>"]
