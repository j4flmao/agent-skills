...
2. [Control Flow Architectures](#control-flow-architectures)
3. [Container vs Presentational](#container-vs-presentational)
4. [Render Props and Children](#render-props-and-children)
5. [Micro-Frontends with Solid](#micro-frontends-with-solid)
...
8. [Islands Architecture](#islands-architecture)
