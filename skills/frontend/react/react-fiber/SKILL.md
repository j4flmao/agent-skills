...
flowchart TD
    ...
    subgraph RenderPhaseRenderPhaseInterruptible ["RenderPhase ["Render Phase (Interruptible)"]"]
    ...
    subgraph CommitPhaseCommitPhaseSynchronous ["CommitPhase ["Commit Phase (Synchronous)"]"]
