...
flowchart TD
    ...
    subgraph KernelSpaceKernelSpace ["<div style='padding-bottom: 40px;'>Kernel Space</div>"]
    ...
    subgraph SecurityAgentegTetragonFalcoSecurityAgentegTetragonFalco ["<div style='padding-bottom: 40px;'>Security Agent (e.g., Tetragon/Falco)</div>"]
