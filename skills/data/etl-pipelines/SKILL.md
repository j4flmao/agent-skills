...
flowchart TD
    ...
    subgraph AirflowOrchestrationAirflowOrchestrationAirflowOrchestrationAirflowOrchestration ["<div style='padding-bottom: 40px;'>AirflowOrchestration ['Airflow Orchestration</div>"]
    A
    B
    C
    end
