...
name: zero-trust
description: >
  Comprehensive expert-level implementation of zero-trust methodologies, providing deep 
...
This skill encapsulates the entirety of the zero-trust domain, providing subagents with the exact procedural logic, architectural blueprints, and cryptographic / security primitives required to implement, audit, or enforce zero-trust within enterprise ecosystems.
...
## Agent Protocol
- Triggers: Any mention of zero-trust, security audits, or architectural reviews.
...
```text
  [Ingress] -> [WAF/Gateway] -> [zero-trust Validator] -> [Data Layer]
                                     |
                               [Audit Log]
```
