...
name: iam-governance
description: >
  Comprehensive expert-level implementation of iam-governance methodologies, providing deep 
...
This skill encapsulates the entirety of the iam-governance domain, providing subagents with the exact procedural logic, architectural blueprints, and cryptographic / security primitives required to implement, audit, or enforce iam-governance within enterprise ecosystems.
...
## Agent Protocol
- Triggers: Any mention of iam-governance, security audits, or architectural reviews.
...
```text
  [Ingress] -> [WAF/Gateway] -> [iam-governance Validator] -> [Data Layer]
                                     |
                               [Audit Log]
```
