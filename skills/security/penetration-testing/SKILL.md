...
description: >
  Comprehensive expert-level implementation of penetration-testing methodologies, providing deep 
...
This skill encapsulates the entirety of the penetration-testing domain, providing subagents with the exact procedural logic, architectural blueprints, and cryptographic / security primitives required to implement, audit, or enforce penetration-testing within enterprise ecosystems.
...
## Agent Protocol
- Triggers: Any mention of penetration-testing, security audits, or architectural reviews.
...
```text
  [Ingress] -> [WAF/Gateway] -> [penetration-testing Validator] -> [Data Layer]
                                     |
                               [Audit Log]
```
