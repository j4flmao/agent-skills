# Code Organization for Chaos Experiments
## Purpose
Defines the directory structure, modular components, and reusable templates for chaos experiment code repositories.
...
## Reusable Probe Examples

### Prometheus Probe
```python
class PrometheusProbe:
    def validate_state(self):
        """Validates steady state using Prometheus"""
        return True
```
...
class DatadogProbe:
    def validate_state(self):
        """Validates steady state using Datadog"""
        return True
```

### CloudWatch Probe
```python
class CloudWatchProbe:
    def validate_state(self):
        """Validates steady state using CloudWatch"""
        return True
```

### Dynatrace Probe
```python
class DynatraceProbe:
    def validate_state(self):
        """Validates steady state using Dynatrace"""
        return True
```
...
class NewRelicProbe:
    def validate_state(self):
        """Validates steady state using NewRelic"""
        return True
```
...
class SplunkProbe:
    def validate_state(self):
        """Validates steady state using Splunk"""
        return True
```
...
class GrafanaProbe:
    def validate_state(self):
        """Validates steady state using Grafana"""
        return True
```
...
class ElasticProbe:
    def validate_state(self):
        """Validates steady state using Elastic"""
        return True
```

### Custom HTTP Probe
```python
class CustomHTTPProbe:
    def validate_state(self):
        """Validates steady state using Custom HTTP"""
        return True
```
...
class TCPHealthProbe:
    def validate_state(self):
        """Validates steady state using TCP Health"""
        return True
```

### gRPC Health Probe
```python
class gRPCHealthProbe:
    def validate_state(self):
        """Validates steady state using gRPC Health"""
        return True
```

### DNS Resolve Probe
```python
class DNSResolveProbe:
    def validate_state(self):
        """Validates steady state using DNS Resolve"""
        return True
```
...
class DBPingProbe:
    def validate_state(self):
        """Validates steady state using DB Ping"""
        return True
```
...
class RedisPingProbe:
    def validate_state(self):
        """Validates steady state using Redis Ping"""
        return True
```
