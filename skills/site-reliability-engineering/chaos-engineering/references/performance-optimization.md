# Performance Optimization for Chaos Agents
## Purpose
Chaos agents must not introduce unintended performance degradation. This document provides guidelines for optimizing chaos agents using eBPF, tuning resource limits, and minimizing observer effect.

## eBPF vs Sidecar CPU Overhead

### Scenario 1: High-throughput Network Delay Injection
- **Target Profile**: 1000 requests per second.
- **Sidecar Overhead**: ~1.5% CPU usage.
- **eBPF Overhead**: ~0.1% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
metadata:
  name: network-delay-ebpf
spec:
  action: delay
  mode: all
  selector:
...
### Scenario 2: High-throughput Network Delay Injection
- **Target Profile**: 2000 requests per second.
- **Sidecar Overhead**: ~3.0% CPU usage.
- **eBPF Overhead**: ~0.2% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
...
### Scenario 3: High-throughput Network Delay Injection
- **Target Profile**: 3000 requests per second.
- **Sidecar Overhead**: ~4.5% CPU usage.
- **eBPF Overhead**: ~0.30000000000000004% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
...
### Scenario 4: High-throughput Network Delay Injection
- **Target Profile**: 4000 requests per second.
- **Sidecar Overhead**: ~6.0% CPU usage.
- **eBPF Overhead**: ~0.4% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
...
### Scenario 5: High-throughput Network Delay Injection
- **Target Profile**: 5000 requests per second.
- **Sidecar Overhead**: ~7.5% CPU usage.
- **eBPF Overhead**: ~0.5% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
...
### Scenario 6: High-throughput Network Delay Injection
- **Target Profile**: 6000 requests per second.
- **Sidecar Overhead**: ~9.0% CPU usage.
- **eBPF Overhead**: ~0.6000000000000001% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
...
### Scenario 7: High-throughput Network Delay Injection
- **Target Profile**: 7000 requests per second.
- **Sidecar Overhead**: ~10.5% CPU usage.
- **eBPF Overhead**: ~0.7000000000000001% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
...
### Scenario 8: High-throughput Network Delay Injection
- **Target Profile**: 8000 requests per second.
- **Sidecar Overhead**: ~12.0% CPU usage.
- **eBPF Overhead**: ~0.8% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
...
### Scenario 9: High-throughput Network Delay Injection
- **Target Profile**: 9000 requests per second.
- **Sidecar Overhead**: ~13.5% CPU usage.
- **eBPF Overhead**: ~0.9% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
...
### Scenario 10: High-throughput Network Delay Injection
- **Target Profile**: 10000 requests per second.
- **Sidecar Overhead**: ~15.0% CPU usage.
- **eBPF Overhead**: ~1.0% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
...
### Scenario 11: High-throughput Network Delay Injection
- **Target Profile**: 11000 requests per second.
- **Sidecar Overhead**: ~16.5% CPU usage.
- **eBPF Overhead**: ~1.1% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
...
### Scenario 12: High-throughput Network Delay Injection
- **Target Profile**: 12000 requests per second.
- **Sidecar Overhead**: ~18.0% CPU usage.
- **eBPF Overhead**: ~1.2000000000000002% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
...
### Scenario 13: High-throughput Network Delay Injection
- **Target Profile**: 13000 requests per second.
- **Sidecar Overhead**: ~19.5% CPU usage.
- **eBPF Overhead**: ~1.3% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
...
### Scenario 14: High-throughput Network Delay Injection
- **Target Profile**: 14000 requests per second.
- **Sidecar Overhead**: ~21.0% CPU usage.
- **eBPF Overhead**: ~1.4000000000000001% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
...
### Scenario 15: High-throughput Network Delay Injection
- **Target Profile**: 15000 requests per second.
- **Sidecar Overhead**: ~22.5% CPU usage.
- **eBPF Overhead**: ~1.5% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
...
### Scenario 16: High-throughput Network Delay Injection
- **Target Profile**: 16000 requests per second.
- **Sidecar Overhead**: ~24.0% CPU usage.
- **eBPF Overhead**: ~1.6% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
...
### Scenario 17: High-throughput Network Delay Injection
- **Target Profile**: 17000 requests per second.
- **Sidecar Overhead**: ~25.5% CPU usage.
- **eBPF Overhead**: ~1.7000000000000002% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
...
### Scenario 18: High-throughput Network Delay Injection
- **Target Profile**: 18000 requests per second.
- **Sidecar Overhead**: ~27.0% CPU usage.
- **eBPF Overhead**: ~1.8% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
...
### Scenario 19: High-throughput Network Delay Injection
- **Target Profile**: 19000 requests per second.
- **Sidecar Overhead**: ~28.5% CPU usage.
- **eBPF Overhead**: ~1.9000000000000001% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
...
### Scenario 20: High-throughput Network Delay Injection
- **Target Profile**: 20000 requests per second.
- **Sidecar Overhead**: ~30.0% CPU usage.
- **eBPF Overhead**: ~2.0% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
...
### Scenario 21: High-throughput Network Delay Injection
- **Target Profile**: 21000 requests per second.
- **Sidecar Overhead**: ~31.5% CPU usage.
- **eBPF Overhead**: ~2.1% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
...
### Scenario 22: High-throughput Network Delay Injection
- **Target Profile**: 22000 requests per second.
- **Sidecar Overhead**: ~33.0% CPU usage.
- **eBPF Overhead**: ~2.2% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
...
### Scenario 23: High-throughput Network Delay Injection
- **Target Profile**: 23000 requests per second.
- **Sidecar Overhead**: ~34.5% CPU usage.
- **eBPF Overhead**: ~2.3000000000000003% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
...
### Scenario 24: High-throughput Network Delay Injection
- **Target Profile**: 24000 requests per second.
- **Sidecar Overhead**: ~36.0% CPU usage.
- **eBPF Overhead**: ~2.4000000000000004% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
...
### Scenario 25: High-throughput Network Delay Injection
- **Target Profile**: 25000 requests per second.
- **Sidecar Overhead**: ~37.5% CPU usage.
- **eBPF Overhead**: ~2.5% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
...
### Scenario 26: High-throughput Network Delay Injection
- **Target Profile**: 26000 requests per second.
- **Sidecar Overhead**: ~39.0% CPU usage.
- **eBPF Overhead**: ~2.6% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
...
### Scenario 27: High-throughput Network Delay Injection
- **Target Profile**: 27000 requests per second.
- **Sidecar Overhead**: ~40.5% CPU usage.
- **eBPF Overhead**: ~2.7% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
...
### Scenario 28: High-throughput Network Delay Injection
- **Target Profile**: 28000 requests per second.
- **Sidecar Overhead**: ~42.0% CPU usage.
- **eBPF Overhead**: ~2.8000000000000003% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
...
### Scenario 29: High-throughput Network Delay Injection
- **Target Profile**: 29000 requests per second.
- **Sidecar Overhead**: ~43.5% CPU usage.
- **eBPF Overhead**: ~2.9000000000000004% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
...
### Scenario 30: High-throughput Network Delay Injection
- **Target Profile**: 30000 requests per second.
- **Sidecar Overhead**: ~45.0% CPU usage.
- **eBPF Overhead**: ~3.0% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
...
### Scenario 31: High-throughput Network Delay Injection
- **Target Profile**: 31000 requests per second.
- **Sidecar Overhead**: ~46.5% CPU usage.
- **eBPF Overhead**: ~3.1% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
...
### Scenario 32: High-throughput Network Delay Injection
- **Target Profile**: 32000 requests per second.
- **Sidecar Overhead**: ~48.0% CPU usage.
- **eBPF Overhead**: ~3.2% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
...
### Scenario 33: High-throughput Network Delay Injection
- **Target Profile**: 33000 requests per second.
- **Sidecar Overhead**: ~49.5% CPU usage.
- **eBPF Overhead**: ~3.3000000000000003% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
...
### Scenario 34: High-throughput Network Delay Injection
- **Target Profile**: 34000 requests per second.
- **Sidecar Overhead**: ~51.0% CPU usage.
- **eBPF Overhead**: ~3.4000000000000004% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
...
### Scenario 35: High-throughput Network Delay Injection
- **Target Profile**: 35000 requests per second.
- **Sidecar Overhead**: ~52.5% CPU usage.
- **eBPF Overhead**: ~3.5% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
...
### Scenario 36: High-throughput Network Delay Injection
- **Target Profile**: 36000 requests per second.
- **Sidecar Overhead**: ~54.0% CPU usage.
- **eBPF Overhead**: ~3.6% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
...
### Scenario 37: High-throughput Network Delay Injection
- **Target Profile**: 37000 requests per second.
- **Sidecar Overhead**: ~55.5% CPU usage.
- **eBPF Overhead**: ~3.7% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
...
### Scenario 38: High-throughput Network Delay Injection
- **Target Profile**: 38000 requests per second.
- **Sidecar Overhead**: ~57.0% CPU usage.
- **eBPF Overhead**: ~3.8000000000000003% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
...
### Scenario 39: High-throughput Network Delay Injection
- **Target Profile**: 39000 requests per second.
- **Sidecar Overhead**: ~58.5% CPU usage.
- **eBPF Overhead**: ~3.9000000000000004% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
...
### Scenario 40: High-throughput Network Delay Injection
- **Target Profile**: 40000 requests per second.
- **Sidecar Overhead**: ~60.0% CPU usage.
- **eBPF Overhead**: ~4.0% CPU usage.
- **Recommendation**: Use eBPF-based traffic control (`tc`) for precise delays.
```yaml
apiVersion: chaos-mesh.org/v1alpha1
kind: NetworkChaos
