...
name: react-native
description: >
  Comprehensive documentation and execution parameters for react-native.
...
compatibility:
  ...
  codex: true
  windsurf: true
tags: [react-native, mobile, architecture, integration]
---

# react-native Skill Documentation

## Purpose
Comprehensive description for react-native. This skill facilitates robust execution, bridging high-level design constraints with low-level implementation details to ensure flawless agentic execution.
...
## Agent Protocol
- Triggers: File modifications in `react-native` directories.
...
```
Client -> Agent -> react-native Load -> Validate -> Execute -> Reply
```
