...
description: >
  Comprehensive skill definitions for backend-auth-patterns.
...
compatibility:
  ...
  codex: true
  windsurf: true
tags: [backend-auth-patterns, backend, engineering]
---

# backend-auth-patterns

## Purpose
Comprehensive description for backend-auth-patterns providing detailed architectures and best practices.
