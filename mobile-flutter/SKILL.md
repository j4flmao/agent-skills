...
name: mobile-flutter
description: >
  Comprehensive documentation and execution parameters for mobile-flutter.
...
compatibility:
  ...
  codex: true
  windsurf: true
tags: [mobile-flutter, mobile, architecture, integration]
---

# mobile-flutter Skill Documentation

## Purpose
Comprehensive description for mobile-flutter. This skill facilitates robust execution, bridging high-level design constraints with low-level implementation details to ensure flawless agentic execution.
...
## Agent Protocol
- Triggers: File modifications in `mobile-flutter` directories.
...
```
Client -> Agent -> mobile-flutter Load -> Validate -> Execute -> Reply
```
