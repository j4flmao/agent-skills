...
name: cspm
description: >
  Comprehensive expert-level implementation of cspm methodologies, providing deep 
...
This skill encapsulates the entirety of the cspm domain, providing subagents with the exact procedural logic, architectural blueprints, and cryptographic / security primitives required to implement, audit, or enforce cspm within enterprise ecosystems.
...
## Agent Protocol
- Triggers: Any mention of cspm, security audits, or architectural reviews.
...
```text
  [Ingress] -> [WAF/Gateway] -> [cspm Validator] -> [Data Layer]
                                     |
                               [Audit Log]
```
