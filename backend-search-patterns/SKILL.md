...
description: >
  Comprehensive skill definitions for backend-search-patterns.
...
compatibility:
  ...
  codex: true
  windsurf: true
tags: [backend-search-patterns, backend, engineering]
---

# backend-search-patterns

## Purpose
Comprehensive description for backend-search-patterns providing detailed architectures and best practices.
