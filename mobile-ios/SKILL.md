...
name: mobile-ios
description: >
  Comprehensive documentation and execution parameters for mobile-ios.
...
compatibility:
  ...
  codex: true
  windsurf: true
tags: [mobile-ios, mobile, architecture, integration]
---

# mobile-ios Skill Documentation

## Purpose
Comprehensive description for mobile-ios. This skill facilitates robust execution, bridging high-level design constraints with low-level implementation details to ensure flawless agentic execution.
...
## Agent Protocol
- Triggers: File modifications in `mobile-ios` directories.
...
```
Client -> Agent -> mobile-ios Load -> Validate -> Execute -> Reply
```
