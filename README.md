...
638 agent skills for software development — planning, architecture, low-level, backend, frontend, desktop, mobile, devops, management, enterprise, product, ml, ai, security, data, data-science, design, quality, blockchain, prompt-engineering, cloud-native, system-design, site-reliability-engineering, game. Each skill is a `SKILL.md` defining triggers, rules, and response format.
...
npx skills add j4flmao/agent-skills            # all 638 skills
