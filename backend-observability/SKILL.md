...
description: >
  Comprehensive skill definitions for backend-observability.
...
compatibility:
  ...
  codex: true
  windsurf: true
tags: [backend-observability, backend, engineering]
---

# backend-observability

## Purpose
Comprehensive description for backend-observability providing detailed architectures and best practices.
