...
description: >
  Comprehensive skill definitions for backend-resilience-patterns.
...
compatibility:
  ...
  codex: true
  windsurf: true
tags: [backend-resilience-patterns, backend, engineering]
---

# backend-resilience-patterns

## Purpose
Comprehensive description for backend-resilience-patterns providing detailed architectures and best practices.
