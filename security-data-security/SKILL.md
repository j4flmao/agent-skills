...
description: >
  Comprehensive expert-level implementation of security-data-security methodologies, providing deep 
...
This skill encapsulates the entirety of the security-data-security domain, providing subagents with the exact procedural logic, architectural blueprints, and cryptographic / security primitives required to implement, audit, or enforce security-data-security within enterprise ecosystems.
...
## Agent Protocol
- Triggers: Any mention of security-data-security, security audits, or architectural reviews.
...
```text
  [Ingress] -> [WAF/Gateway] -> [security-data-security Validator] -> [Data Layer]
                                     |
                               [Audit Log]
```
