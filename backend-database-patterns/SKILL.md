...
description: >
  Comprehensive skill definitions for backend-database-patterns.
...
compatibility:
  ...
  codex: true
  windsurf: true
tags: [backend-database-patterns, backend, engineering]
---

# backend-database-patterns

## Purpose
Comprehensive description for backend-database-patterns providing detailed architectures and best practices.
