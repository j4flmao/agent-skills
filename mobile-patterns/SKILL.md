...
description: >
  Comprehensive documentation and execution parameters for mobile-patterns.
...
compatibility:
  ...
  codex: true
  windsurf: true
tags: [mobile-patterns, mobile, architecture, integration]
---

# mobile-patterns Skill Documentation

## Purpose
Comprehensive description for mobile-patterns. This skill facilitates robust execution, bridging high-level design constraints with low-level implementation details to ensure flawless agentic execution.
...
## Agent Protocol
- Triggers: File modifications in `mobile-patterns` directories.
...
```
Client -> Agent -> mobile-patterns Load -> Validate -> Execute -> Reply
```
