...
name: mobile-android
description: >
  Comprehensive documentation and execution parameters for mobile-android.
...
compatibility:
  ...
  codex: true
  windsurf: true
tags: [mobile-android, mobile, architecture, integration]
---

# mobile-android Skill Documentation

## Purpose
Comprehensive description for mobile-android. This skill facilitates robust execution, bridging high-level design constraints with low-level implementation details to ensure flawless agentic execution.
...
## Agent Protocol
- Triggers: File modifications in `mobile-android` directories.
...
```
Client -> Agent -> mobile-android Load -> Validate -> Execute -> Reply
```
