...
description: >
  Comprehensive expert-level implementation of security-container-security methodologies, providing deep 
...
This skill encapsulates the entirety of the security-container-security domain, providing subagents with the exact procedural logic, architectural blueprints, and cryptographic / security primitives required to implement, audit, or enforce security-container-security within enterprise ecosystems.
...
## Agent Protocol
- Triggers: Any mention of security-container-security, security audits, or architectural reviews.
...
```json
{
  "finding_id": "SEC-001",
  "severity": "CRITICAL",
  "domain": "security-container-security",
  "remediation_plan": "..."
}
```
...
```text
  [Ingress] -> [WAF/Gateway] -> [security-container-security Validator] -> [Data Layer]
                                     |
                               [Audit Log]
```
